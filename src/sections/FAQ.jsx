            ...
            <div className="mt-16 flex flex-col md:flex-row items-center justify-between border-t border-navy/10 pt-8 gap-6 max-w-7xl mx-auto w-full">
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-2">
                        {/* Facebook */}
                        <a href="#" className="w-[38px] h-[38px] rounded-full bg-[#3b5998] flex items-center justify-center hover:opacity-90 transition-opacity shadow-sm">
                        ...
                        {/* Instagram */}
                        <a href="#" className="w-[38px] h-[38px] rounded-full bg-gradient-to-tr from-[#FD1D1D] via-[#E1306C] to-[#C13584] flex items-center justify-center hover:opacity-90 transition-opacity shadow-sm relative overflow-hidden">
